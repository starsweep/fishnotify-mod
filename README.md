...
- **Alert sound**: plays default exp chime (`minecraft:entity.experience_orb.pickup`) directly through sound engine. You can replace the default noise in the config menu and play your own sounds via `javax.sound.sampled` with independent gain control. Supports .wav.
